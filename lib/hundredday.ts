...
export const WORKSTREAMS_100: Workstream100[] = [
  // ── 1. GROWTH ────────────────────────────────────────────────────────────
  {
    ...
    tasks: [
      { id: "ai-1", ranking: null, subtasks: [], description: "Centralize 100% of clinical/operational data into a single data store to establish context for AI transformation", dueDate: "Aug 15, 2026", accountable: "", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "ai-2", ranking: null, subtasks: [], description: "Develop clinical and operational safeguards/process for secure, safe AI deployment (data access controls, clinical oversight, escalation paths)", dueDate: "TBD", accountable: "", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "ai-3", ranking: null, subtasks: [], description: "Identify 5 functional leaders to own ongoing testing and deployment of AI infrastructure/tooling", dueDate: "TBD", accountable: "", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "ai-4", ranking: null, subtasks: [], description: "Define 5 AI agents across those functional areas, each with explicit success KPIs", dueDate: "TBD", accountable: "", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "ai-5", ranking: null, subtasks: [], description: "Deploy the 5 agents into production and begin measuring against defined KPIs", dueDate: "TBD", accountable: "", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "ai-6", ranking: null, subtasks: [], description: "Build a culture/change-management plan for how teams engage with the AI toolkit, so adoption scales beyond the initial 5 agents", dueDate: "TBD", accountable: "", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
    ],
  },
  {
    id: "dtc",
    ...
    tasks: [
      { id: "dtc-1", ranking: null, subtasks: [], description: "Complete evaluation of MHS growth-engine and deliver written diagnosis", dueDate: "Jul 10, 2026", accountable: "Derek", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "DF: Substantially done, sharing soon." },
      { id: "dtc-2", ranking: null, subtasks: [], description: "Fix SMS/email opt-in capture across all MHS forms & intake", dueDate: "ASAP", accountable: "Jen / Sydney", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
      ...
      { id: "dtc-4", ranking: null, subtasks: [], description: "Ramp Matchnode spend and optimize for correct endpoint (interventional appointment if possible, consult completed if not — NOT just 'lead')", dueDate: "Aug 15, 2026", accountable: "Derek / Emery", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "dtc-5", ranking: null, subtasks: [], description: "Deploy Radial signup & booking flow including supporting infrastructure (benefits verification, AI customer agent) to MHS clinic network — especially booking discovery calls vs. direct calls/follow-ups", dueDate: "TBD", accountable: "Carlene / Derek", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "DF: This likely needs to be piloted first." },
      { id: "dtc-6", ranking: null, subtasks: [], description: "Once NPS measurement is in place (dependency), get review engine going across all clinics", dueDate: "Aug 15, 2026", accountable: "Jen / Carlene", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "dtc-7", ranking: null, subtasks: [], description: "Standardize CAC, LTV:CAC, and interventional-mix KPIs by clinic, customer, and channel cohort", dueDate: "Aug 15, 2026", accountable: "Mackensie", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "dtc-8", ranking: null, subtasks: [], description: "Create one big trusted dashboard spanning both networks", dueDate: "Aug 15, 2026", accountable: "Mackensie", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "dtc-9", ranking: null, subtasks: [], description: "Create and track clinic-by-clinic capacity across all clinics, and increasingly tie that information back automatically into paid spend", dueDate: "Sep 15, 2026", accountable: "Mackensie", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "DF: Could split this one in two." },
      { id: "dtc-10", ranking: null, subtasks: [], description: "Resolve HubSpot / Customer.io LCM plans and integration", dueDate: "Sep 15, 2026", accountable: "Jen / Mackensie", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "dtc-11", ranking: null, subtasks: [], description: "Pending brand decision: update/improve MHS website (also social media)", dueDate: "Sep 15, 2026", accountable: "Derek / Jen", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "dtc-12", ranking: null, subtasks: [], description: "Pending brand decision: decide on content & SEO/GEO plan for MHS", dueDate: "Sep 15, 2026", accountable: "Derek / Emery", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "dtc-13", ranking: null, subtasks: [], description: "Pending brand decision: launch MHS lifecycle v1", dueDate: "TBD", accountable: "Derek / Mackensie", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "dtc-14", ranking: null, subtasks: [], description: "Evaluate low-hanging-fruit opportunities in existing MHS panel (e.g. SAINT deployment, SWIFT protocol scaling in WA/CA, 2x/day TMS)", dueDate: "TBD", accountable: "", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "dtc-15", ranking: null, subtasks: [], description: "Develop prioritized new intervention roadmap (PRISM, Proliv-Rx, SAINT, COMP360, MDMA) targeting outcome and interventional-mix improvement", dueDate: "TBD", accountable: "", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
    ],
  },
  {
    id: "b2b",
    ...
    tasks: [
      { id: "b2b-1", ranking: null, subtasks: [], description: "Consolidate two legacy BD sales teams under 1 leader", dueDate: "Aug 3, 2026", accountable: "Sydney / Jonathan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "Define reporting cadence, owners, review forums, source of truth, and how performance will be managed." },
      { id: "b2b-2", ranking: null, subtasks: [], description: "Consolidate all BD activity into legacy MHS HubSpot CRM", dueDate: "Aug 3, 2026", accountable: "Sydney / Jonathan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "b2b-3", ranking: null, subtasks: [], description: "Implement Regional Market Strategy Growth Forum to identify and implement local market growth plans (BD, Marketing, RVP, PL, RMDs)", dueDate: "Aug 3, 2026", accountable: "Sydney", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "Already established for MHS clinics." },
      { id: "b2b-4", ranking: null, subtasks: [], description: "Integrate compensation and incentive programs (Base/Variable); goal is to move to cash collections from new referrals commission program", dueDate: "TBD", accountable: "", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "b2b-5", ranking: null, subtasks: [], description: "Create budget and financial projections for the BD function", dueDate: "Aug 14, 2026", accountable: "Sydney / Jonathan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "Establish cost of BD function (salaries, travel, marketing materials, CRM, tech) weighted against projected patient volume and revenue generated from referrals." },
      { id: "b2b-6", ranking: null, subtasks: [], description: "Create one referral-to-scheduling process across both organizations so referring providers experience a consistent, white-glove process", dueDate: "Sep 15, 2026", accountable: "Sydney / Jonathan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "b2b-7", ranking: null, subtasks: [], description: "Define ideal BD rep territory size, target referrer segmentation, and prioritized criteria based on volume potential, geography, and specialty fit", dueDate: "Sep 15, 2026", accountable: "Sydney / Jonathan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "b2b-8", ranking: null, subtasks: [], description: "Define sales/outreach process and cadence — from prospecting to first visit to ongoing relationship management, including call/visit frequency benchmarks", dueDate: "Sep 15, 2026", accountable: "Sydney / Jonathan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
  ...
  },
  {
    ...
    tasks: [
      { id: "ltc-1", ranking: null, subtasks: [], description: "Remi evaluation for legacy MHS", dueDate: "Jul 17, 2026", accountable: "Sydney / Dulce", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "Dulce/Sydney demo on 7/8; meeting again with MDHub on 7/10 to discuss next steps." },
      { id: "ltc-2", ranking: null, subtasks: [], description: "RadialOS evaluation for legacy MHS", dueDate: "Jul 17, 2026", accountable: "Sydney / Dulce", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "Meeting scheduled with Carlene to review functionality on 7/10." },
      { id: "ltc-3", ranking: null, subtasks: [], description: "Map the end-to-end customer journey from discovery call through intake scheduling and treatment start", dueDate: "Jul 24, 2026", accountable: "Leah / Dulce / Sydney / Ryan", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "Include all customer touchpoints, handoffs, and drop-off points." },
      { id: "ltc-4", ranking: null, subtasks: [], description: "Evaluate Mindful and Radial Care Navigation playbooks, workflows, scripts, tools, roles, and handoff points", dueDate: "Jul 31, 2026", accountable: "Leah / Dulce / Ryan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "Evaluate then document current-state assessment across both teams." },
      { id: "ltc-5", ranking: null, subtasks: [], description: "Identify strengths, gaps, and areas of overlap across both Care Navigation models", dueDate: "Jul 31, 2026", accountable: "Leah / Dulce / Sydney", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "Highlight what should be kept, standardized, or improved." },
      { id: "ltc-6", ranking: null, subtasks: [], description: "Define Care Navigation role ownership across new and existing customer workflows", dueDate: "Aug 14, 2026", accountable: "Leah / Dulce / Sydney", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "Clarify responsibilities by customer stage: new lead follow-up, discovery calls, intake scheduling, existing customer support, rescheduling, benefits/pricing questions, PAs and reauthorizations, clinic handoffs, and escalations." },
  ...
  },
  {
    ...
    tasks: [
      { id: "oe-1", ranking: null, subtasks: [], description: "Evaluate Radial RCM and create plan for transition to Arietis RCM vendor", dueDate: "Sep 1, 2026", accountable: "", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
      { id: "oe-2", ranking: null, subtasks: [], description: "Transition Radial Clinics into Daily Demand vs Capacity (Sales/Ops)", dueDate: "Jul 10, 2026", accountable: "Sydney", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
      { id: "oe-3", ranking: null, subtasks: [], description: "Transition Radial Clinics into Weekly Clinic Profitability Improvement Forum", dueDate: "Jul 9, 2026", accountable: "Leah", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
      { id: "oe-4", ranking: null, subtasks: [], description: "Transition Radial Clinic Leadership into Service Line Product Review Forums", dueDate: "Jul 14, 2026", accountable: "Sydney", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "oe-5", ranking: null, subtasks: [], description: "Transition Radial Practice Leaders into Weekly RVP Call", dueDate: "Jul 21, 2026", accountable: "Leah / Brenda / Kyle", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "oe-6", ranking: null, subtasks: [], description: "Transition Radial Key Leadership to Real Estate Review Meeting", dueDate: "Aug 3, 2026", accountable: "Leah / Josh", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
    ],
  },
  {
    id: "product-data",
    ...
    tasks: [
      ...
      { id: "pd-4", ranking: null, subtasks: [], description: "Map clinic-level P&L / utilization dashboard requirements into the RadialOS analytics roadmap", dueDate: "TBD", accountable: "Leah / Steph / Mark / Carlene", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "Joint item with Operations & Shared Services. Cascade heavily involved." },
      { id: "pd-5", ranking: null, subtasks: [], description: "RCM tech stack consolidation", dueDate: "Sep 30, 2026", accountable: "Carlene / Steph / Sydney", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "Ongoing assessment of MHS processes and tools in parallel with launching pilot for PAs and BI/BV with Foresight (built on Stedi) for Radial sites. If pilot goes well, expand to Radial claims processing → MHS claims processing (full clearinghouse migrations for both orgs)." },
    ],
  },
  ...
  // ── 2. ONE TEAM ──────────────────────────────────────────────────────────
  {
    ...
    tasks: [
      { id: "fin-1", ranking: null, subtasks: [], description: "Interim CFO: identified and onboarded", dueDate: "TBD", accountable: "Mark / John", responsible: "", consulted: "", informed: "", status: "Complete", notes: "" },
      { id: "fin-2", ranking: null, subtasks: [], description: "Hire permanent CFO", dueDate: "Sep 30, 2026", accountable: "Mark / John", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "Need to identify candidate, conduct interview process (recommend a case study), negotiate contract, and allow for adequate notice/onboarding time." },
      ...
      { id: "fin-8", ranking: null, subtasks: [], description: "Tax: finalize 2025 returns; get landscape of total tax exposure", dueDate: "Q3 2026", accountable: "Chris / Pete / WP", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "Leverage Whitley Penn to assist." },
    ],
  },
  {
    id: "it-security",
    ...
    tasks: [
      { id: "it-1", ranking: null, subtasks: [], description: "Evaluate MHS IT team (4 FTE, operating near capacity) and determine combined leadership structure", dueDate: "Jul 31, 2026", accountable: "Elliot", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
      { id: "it-2", ranking: null, subtasks: [], description: "Engage RSM for tactical IT support", dueDate: "Jul 20, 2026", accountable: "John / Elliot", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "it-3", ranking: null, subtasks: [], description: "Resolve February 2026 phishing-related email compromise incident; determine OCR reporting obligation", dueDate: "TBD", accountable: "Elliot / John / Legal", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
      { id: "it-4", ranking: null, subtasks: [], description: "Execute quick-win security items: penetration testing, data privacy remediation, domain/ownership cleanup", dueDate: "TBD", accountable: "Elliot / Jordan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "it-5", ranking: null, subtasks: [], description: "Assess end-of-life hardware/software and build a device management / enrollment plan", dueDate: "TBD", accountable: "Elliot / Jordan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "it-6", ranking: null, subtasks: [], description: "Replace end-of-life network hardware (~11 Meraki switches, 12 access points, 1 firewall); add backup internet at 16 of 22 locations", dueDate: "TBD", accountable: "Elliot / Jordan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "it-7", ranking: null, subtasks: [], description: "Define target-state application portfolio and integration roadmap (joint with Product, Data & Clinical Innovation)", dueDate: "TBD", accountable: "Elliot / Jordan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "it-8", ranking: null, subtasks: [], description: "Establish a HIPAA security risk-management program, including obtaining missing BAAs not provided in diligence", dueDate: "TBD", accountable: "Elliot / Jordan / Dan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "it-9", ranking: null, subtasks: [], description: "Develop a formal IT strategy, roadmap, and budget for the combined entity", dueDate: "TBD", accountable: "Elliot / John / RSM", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
    ],
  },
  {
    id: "people",
    ...
    tasks: [
      ...
      { id: "ppl-3", ranking: null, subtasks: [], description: "File delinquent TMS 2024 Form 5500 via the DOL Delinquent Filer Voluntary Compliance Program", dueDate: "Jun 30, 2026", accountable: "Abbe", responsible: "", consulted: "", informed: "", status: "Complete", notes: "The form is not delinquent. It was due June 30, 2026 and was filed." },
      { id: "ppl-4", ranking: null, subtasks: [], description: "Audit FLSA exempt/non-exempt classifications network-wide and correct misclassifications", dueDate: "Jul 30, 2026", accountable: "Abbe", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "MHS has reviewed 1099 status and has documents prepared to adjust as necessary for physicians. Was on-hold due to the diligence process." },
  ...
  },
  {
    ...
    tasks: [
      { id: "leg-1", ranking: null, subtasks: [], description: "Build master diligence-issue tracker (owner, plan, cost estimate, target date) across tax / labor / privacy / regulatory findings", dueDate: "TBD", accountable: "Dan", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
  ...
  },
  {
    ...
    tasks: [
      { id: "com-1", ranking: null, subtasks: [], description: "Finalize Day-1 internal messaging (shared mission, leadership structure, no-surprises commitments) and proactive FAQ", dueDate: "Jun 24, 2026", accountable: "John", responsible: "", consulted: "", informed: "", status: "Complete", notes: "Should have landed before the external announcement — confirm and archive final version." },
      { id: "com-2", ranking: null, subtasks: [], description: "Launch July external announcement with Tier 1 press exclusive (WSJ / Bloomberg / CNBC) via 120/80 and GC comms team", dueDate: "TBD", accountable: "Derek / John", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "See Growth/Brand tabs." },
  ...
  // ── 3. REMISSION ─────────────────────────────────────────────────────────
  {
    ...
    tasks: [
      ...
      { id: "cp-2", ranking: null, subtasks: [], description: "Build network-wide clinician capacity plan (coverage and ramp assumptions through EOY '26)", dueDate: "Aug 1, 2026", accountable: "Toby / Leah", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "Working on this right now." },
      ...
      { id: "cp-4", ranking: null, subtasks: [], description: "Establish network-wide clinical quality & safety SLAs (questionnaire completion, outcome tracking, safety event reporting)", dueDate: "Oct 1, 2026", accountable: "Toby / Leah", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      ...
      { id: "cp-11", ranking: null, subtasks: [], description: "Transition Radial Medical Team into weekly Toby Grand Rounds meeting", dueDate: "Jul 17, 2026", accountable: "Toby", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "Starting next week." },
      ...
      { id: "cp-15", ranking: null, subtasks: [], description: "Transition PC ownership (Radial) to Toby", dueDate: "Sep 1, 2026", accountable: "Toby / Owen / John", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
    ],
  },
  ...
  // ── 4. MSO ───────────────────────────────────────────────────────────────
  {
    ...
    tasks: [
      { id: "pay-1", ranking: null, subtasks: [], description: "Assess MHS existing strategic payer relationships and contract terms", dueDate: "TBD", accountable: "", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
      ...
      { id: "pay-3", ranking: null, subtasks: [], description: "Prioritize and schedule meetings with BCBS of SC, Premera and other key payers re: alternative payment models (case rate, bundled payment, VBC)", dueDate: "Aug 8, 2026", accountable: "Jonathan", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
      { id: "pay-4", ranking: null, subtasks: [], description: "Finalize network/MSO marketing material including brochure, presentations, and key messaging", dueDate: "Jul 30, 2026", accountable: "Jonathan", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "Working with BFJ marketing firm." },
      { id: "pay-5", ranking: null, subtasks: [], description: "Engage Anthem BCBS / Carelon regarding National Contract", dueDate: "Aug 8, 2026", accountable: "Jonathan", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
      { id: "pay-6", ranking: null, subtasks: [], description: "Submit network application with short- and long-term disability insurance carriers", dueDate: "TBD", accountable: "Jonathan", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
    ],
  },
  ...
  // ── 5. CATEGORY LEADERSHIP ───────────────────────────────────────────────
  {
    ...
    tasks: [
      ...
      { id: "bm-6", ranking: null, subtasks: [], description: "Get acquisition announced publicly and secure top-tier press coverage", dueDate: "Jul 31, 2026", accountable: "Derek / Emery", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "DF: Press release draft getting feedback right now." },
      { id: "bm-7", ranking: null, subtasks: [], description: "Use acquisition announcement to propel sustained coverage — not just a one-off", dueDate: "Aug 30, 2026", accountable: "Derek / Emery", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "bm-8", ranking: null, subtasks: [], description: "Launch new Research Hub", dueDate: "TBD", accountable: "Derek / Emery", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
      { id: "bm-9", ranking: null, subtasks: [], description: "Launch success stories from patients and providers on our site", dueDate: "TBD", accountable: "Derek / Emery", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "" },
      { id: "bm-10", ranking: null, subtasks: [], description: "Launch insurance coverage checker", dueDate: "TBD", accountable: "Derek / Emery", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      ...
      { id: "bm-13", ranking: null, subtasks: [], description: "Activate AMPA ONE-Z (insomnia) across 3 MHS sites; enroll first 2 patients", dueDate: "Oct 1, 2026", accountable: "Owen / Ahmed", responsible: "", consulted: "", informed: "", status: "In Progress", notes: "First research activation at MHS sites; extends the footprint beyond NY." },
      ...
      { id: "bm-15", ranking: null, subtasks: [], description: "Build and budget the clinical trial team", dueDate: "Aug 22, 2026", accountable: "Owen / Sean", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "bm-16", ranking: null, subtasks: [], description: "Site-network trial product: 2+ Phase II/III trials in contract negotiation with sponsors", dueDate: "Oct 1, 2026", accountable: "Owen", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "bm-17", ranking: null, subtasks: [], description: "Two publications submitted to IF 3+ journals on Brain Medicine topics", dueDate: "Oct 1, 2026", accountable: "Owen", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "bm-18", ranking: null, subtasks: [], description: "Data-monetization contracts underway (e.g. Reziliant)", dueDate: "Sep 21, 2026", accountable: "Owen / Sean", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
      { id: "bm-19", ranking: null, subtasks: [], description: "Brain Medicine press goals (Tier 1 coverage tied to research and podcast) in collaboration with Derek / PR", dueDate: "Aug 7, 2026", accountable: "Owen / Derek", responsible: "", consulted: "", informed: "", status: "Not Started", notes: "" },
    ],
  },
