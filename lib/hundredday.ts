...
export const WORKSTREAMS_100: Workstream100[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "pd-4", description: "Map clinic-level P&L / utilization dashboard requirements into the RadialOS analytics roadmap", dueDate: "", owner: "Leah / Steph / Mark / Carlene", status: "Not Started", notes: "Joint item with Operations & Shared Services. Cascade heavily involved." },
  ...
  },
  {
    ...
    tasks: [
      { id: "fin-1", description: "Interim CFO: identified and onboarded", dueDate: "", owner: "Mark / John", status: "Complete", notes: "" },
      ...
      { id: "fin-6", description: "Consolidate payroll", dueDate: "", owner: "", status: "Not Started", notes: "Payroll needs to be consolidated and handled by Shelby. Recommendation is to truly centralize payroll utilizing MSA agreement (vs. having multiple payrolls for TMS and MHS)." },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "it-7", description: "Establish a HIPAA security risk-management program, including obtaining missing BAAs not provided in diligence", dueDate: "", owner: "", status: "Not Started", notes: "" },
      { id: "it-8", description: "Develop a formal IT strategy, roadmap, and budget for the combined entity", dueDate: "", owner: "", status: "Not Started", notes: "" },
    ],
  },
  {
    id: "people",
    ...
    tasks: [
      { id: "ppl-1", description: "Remediate I-9 compliance gaps (21 of 25 forms reviewed had errors or missing documentation); require new I-9s Day 1", dueDate: "", owner: "", status: "In Progress", notes: "Audit in process with outside counsel for all active MHS teammates." },
      { id: "ppl-2", description: "Verify and resolve active work-authorization lapse (one employee unauthorized since 2023; two permits expiring Nov 2026)", dueDate: "", owner: "", status: "Complete", notes: "The individual with the lapse was terminated May 8, 2026. No action needed on those with still-valid permits." },
      { id: "ppl-3", description: "File delinquent TMS 2024 Form 5500 via the DOL Delinquent Filer Voluntary Compliance Program", dueDate: "", owner: "", status: "Complete", notes: "The form is not delinquent. It was due June 30, 2026 and was filed." },
      { id: "ppl-4", description: "Audit FLSA exempt/non-exempt classifications network-wide and correct misclassifications", dueDate: "", owner: "", status: "In Progress", notes: "MHS has reviewed 1099 status and has documents prepared to adjust as necessary for physicians. Was on-hold due to the diligence process." },
      { id: "ppl-5", description: "Consolidate Rippling / payroll across entities", dueDate: "", owner: "", status: "In Progress", notes: "Reviewing both instances of Rippling to understand the appropriate consolidation timeline and mechanism to minimize UX issues for both entities. Reviewing potential cost savings with Rippling contract consolidation." },
      { id: "ppl-6", description: "Consolidate benefits programs and plan for next renewal cycle", dueDate: "", owner: "", status: "In Progress", notes: "Benefits will remain separate for the 2026–2027 plan year given the timeline of Radial's renewal and the substantial plan differences. Pre-renewal for both entities is in process." },
      { id: "ppl-7", description: "Build a unified employee handbook (merge MHS handbook + TMS Code of Conduct) with CA/WA-specific provisions", dueDate: "", owner: "", status: "In Progress", notes: "The current handbook has all necessary state-specific provisions for all states where TMS/MHS operate, updated in April. Radial handbook with state-specific policies is in process." },
      { id: "ppl-8", description: "Establish baseline employee eNPS measurement (target >80 eNPS)", dueDate: "", owner: "", status: "In Progress", notes: "eNPS should be pushed out to Radial; already done for MHS in April. Goal is 7% increase org-wide (by entity initially) with refinement by role ongoing." },
      { id: "ppl-9", description: "Support resolution of outstanding employment litigation jointly with Legal & Regulatory (2 CA wage-and-hour class actions; individual claims)", dueDate: "", owner: "", status: "In Progress", notes: "In process on all matters; timeline is not easily determined given how litigation progresses." },
    ],
  },
  {
    id: "legal",
    ...
    tasks: [
      { id: "leg-1",  description: "Build master diligence-issue tracker (owner, plan, cost estimate, target date) across tax / labor / privacy / regulatory findings", dueDate: "", owner: "Dan", status: "In Progress", notes: "" },
  ...
  // ── 3. REMISSION ─────────────────────────────────────────────────────────
  {
    ...
    tasks: [
      ...
      { id: "cp-9",  description: "Implement formal occupational health & safety program (written IIPP, Cal/OSHA training, bloodborne pathogen training) for interventional procedures", dueDate: "", owner: "Toby / Abbe", status: "Not Started", notes: "4 open workers' comp claims (Sep'24–Mar'26); no OSHA 300 logs or prior inspection records provided in diligence." },
  ...
  // ── 4. MSO ───────────────────────────────────────────────────────────────
  {
    ...
    tasks: [
      ...
      { id: "pay-2", description: "Define named owner for contracting and credentialing across the combined network going forward", dueDate: "", owner: "", status: "Not Started", notes: "" },
      { id: "pay-3", description: "Confirm Anthem change-of-control notice obligation is satisfied (Provider Agreement Section 9.3.1.2)", dueDate: "", owner: "", status: "Not Started", notes: "" },
      { id: "pay-4", description: "Obtain missing payor contracts not provided in diligence to confirm reimbursement methodology and change-of-control triggers", dueDate: "", owner: "", status: "Not Started", notes: "" },
      { id: "pay-5", description: "Prioritize and schedule meetings with Premera (WA), Anthem Blue Cross of CA, Carelon, and other key payers re: combined network / MSO strategy", dueDate: "Aug 8, 2026", owner: "Jonathan", status: "In Progress", notes: "Met with Premera on 7/7 with follow-up action items. Meeting scheduled with Anthem/Carelon executive leadership on 8/5." },
      { id: "pay-6", description: "Prioritize and schedule meetings with BCBS of SC, Premera and other key payers re: alternative payment models (case rate, bundled payment, VBC)", dueDate: "Aug 8, 2026", owner: "Jonathan", status: "In Progress", notes: "" },
      { id: "pay-7", description: "Finalize network/MSO marketing material including brochure, presentations, and key messaging", dueDate: "Jul 30, 2026", owner: "Jonathan", status: "In Progress", notes: "Working with BFJ marketing firm." },
      { id: "pay-8", description: "Engage Anthem BCBS / Carelon regarding National Contract", dueDate: "Aug 8, 2026", owner: "Jonathan", status: "In Progress", notes: "" },
      { id: "pay-9", description: "Submit network application with short- and long-term disability insurance carriers", dueDate: "", owner: "", status: "Not Started", notes: "" },
    ],
  },
  ...
  // ── 5. CATEGORY LEADERSHIP ───────────────────────────────────────────────
  {
    ...
    tasks: [
      ...
      { id: "bm-6",  description: "Get acquisition announced publicly and secure top-tier press coverage", dueDate: "", owner: "Derek / Emery", status: "In Progress", notes: "DF: Press release draft getting feedback right now." },
