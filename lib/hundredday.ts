...
export const WORKSTREAMS_100: Workstream100[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "it-3", description: "Resolve February 2026 phishing-related email compromise incident; determine OCR reporting obligation", dueDate: "", owner: "Elliot / John / Legal", status: "In Progress", notes: "" },
      { id: "it-4", description: "Execute quick-win security items: penetration testing, data privacy remediation, domain/ownership cleanup", dueDate: "", owner: "Elliot / Jordan", status: "Not Started", notes: "" },
      { id: "it-5", description: "Assess end-of-life hardware/software and build a device management / enrollment plan", dueDate: "", owner: "Elliot / Jordan", status: "Not Started", notes: "" },
      { id: "it-6", description: "Replace end-of-life network hardware (~11 Meraki switches, 12 access points, 1 firewall); add backup internet at 16 of 22 locations", dueDate: "", owner: "Elliot / Jordan", status: "Not Started", notes: "" },
      { id: "it-7", description: "Define target-state application portfolio and integration roadmap (joint with Product, Data & Clinical Innovation)", dueDate: "", owner: "Elliot / Jordan", status: "Not Started", notes: "" },
      { id: "it-8", description: "Establish a HIPAA security risk-management program, including obtaining missing BAAs not provided in diligence", dueDate: "", owner: "Elliot / Jordan / Dan", status: "Not Started", notes: "" },
      { id: "it-9", description: "Develop a formal IT strategy, roadmap, and budget for the combined entity", dueDate: "", owner: "Elliot / John / RSM", status: "In Progress", notes: "" },
    ],
  },
  {
    id: "people",
    ...
    tasks: [
      ...
      { id: "ppl-9", description: "Support resolution of outstanding employment litigation jointly with Legal & Regulatory (2 CA wage-and-hour class actions; individual claims)", dueDate: "", owner: "Abbe", status: "In Progress", notes: "In process on all matters; timeline is not easily determined given how litigation progresses." },
    ],
  },
  {
    id: "legal",
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "com-2", description: "Launch July external announcement with Tier 1 press exclusive (WSJ / Bloomberg / CNBC) via 120/80 and GC comms team", dueDate: "", owner: "Derek / John", status: "In Progress", notes: "See Growth/Brand tabs." },
  ...
  // ── 4. MSO ───────────────────────────────────────────────────────────────
  {
    ...
    tasks: [
      { id: "pay-1", description: "Assess MHS existing strategic payer relationships and contract terms", dueDate: "", owner: "", status: "In Progress", notes: "" },
      ...
      { id: "pay-6", description: "Submit network application with short- and long-term disability insurance carriers", dueDate: "", owner: "Jonathan", status: "Not Started", notes: "" },
    ],
  },
  ...
  // ── 5. CATEGORY LEADERSHIP ───────────────────────────────────────────────
  {
    ...
    tasks: [
      ...
      { id: "bm-4",  description: "Resolve brand architecture decision dependency (Mindful vs. Radial brand) — unlocks external announcement and accelerates this entire workstream", dueDate: "", owner: "Derek / Elliot / John / Owen", status: "Not Started", notes: "Cross-linked to Governance & Cadence item." },
  ...
  // ── MISCELLANEOUS ─────────────────────────────────────────────────────────
  {
    ...
    tasks: [
      ...
      { id: "misc-3", description: "Conduct in-person clinic aesthetic assessment and audit full customer journey at all 21 MHS locations; score each site on cleanliness, signage, furniture condition, brand alignment, and patient-facing environment quality; develop improvement plan/budget if necessary", dueDate: "", owner: "", status: "Not Started", notes: "" },
    ],
  },
];
