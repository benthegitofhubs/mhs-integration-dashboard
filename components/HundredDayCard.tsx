...
export default function HundredDayCard({ workstream, index }: { workstream: Workstream100; index: number }) {
        ...
        <div className="flex items-start justify-between gap-6">
          <div className="flex-1 min-w-0">
            <div className="flex items-baseline gap-2 mb-1">
              ...
              {atRisk > 0 && (
                <span className="text-xs font-semibold" style={{ color: "#c2410c", fontFamily: "var(--font-geist-mono)" }}>
                  · {atRisk} AT RISK
                </span>
              )}
            </div>
